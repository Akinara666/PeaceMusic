...
def build_music_tool_specs(service: MusicService) -> tuple[ToolSpec, ...]:
    ...
    return (
        ToolSpec("play_music", ToolCategory.MUSIC, play_music, PlayMusicArguments),
        ...
        ToolSpec("seek_music", ToolCategory.MUSIC, seek_music, SeekArguments),
        ToolSpec("set_volume", ToolCategory.MUSIC, set_volume, VolumeArguments),
        ToolSpec("set_loop_mode", ToolCategory.MUSIC, set_loop_mode, LoopArguments),
